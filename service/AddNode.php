			...
			::-moz-input-placeholder{
			   color: rgba(255,255,255,0.6);
				...
				<div class="body"></div>
					...
					<input type = "text" name = "node" placeholder="node name">
		...
		if(isset($_POST['addNode'])) {
			...
			$q = "select * from nodes where node_title = '$node'";
			$run_q = mysqli_query($con, $q);
			if(!mysqli_num_rows($run_q)) {

				$q = "insert into nodes (node_title) values ('$node')";
				$run_q = mysqli_query($con, $q);
			}
		}
